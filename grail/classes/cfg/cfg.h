#include <iostream>
using  std::istream;
using std::ostream; //by SH 05/24/2005
...
template <class T>
std::istream& operator >> ( std::istream&, product<T>&);

template <class T>
std::ostream& operator << ( std::ostream&, const product<T>&); //by SH 05/25/2004
...
#ifdef _MSC_VER
	#if _MSC_VER<=1200
	friend	istream& operator>>(istream&, product<T>&);		// stream input
	friend  ostream& operator << ( ostream&, const product<T>&);
	#endif

	#if _MSC_VER>=1300
	friend std::istream& operator >> <T> ( std::istream&, product<T>&);
	friend std::ostream& operator << <T> ( std::ostream&, const product<T>&);
	#endif
#endif
...
template <class T>
std::istream& operator >> ( std::istream&, cfg<T>&);

template <class T>
std::ostream& operator << ( std::ostream&, const cfg<T>&); //by SH 05/25/2005
...
#ifdef _MSC_VER
	#if _MSC_VER<=1200
	friend	istream& operator>>(istream&, cfg<T>&);		// stream input
	friend  ostream& operator << (ostream&, const cfg<T>&);
	#endif

	#if _MSC_VER>=1300
	friend std::istream& operator >> <T> ( std::istream&, cfg<T>&);
	friend std::ostream& operator << <T> ( std::ostream&, const cfg<T>&);
	#endif
#endif
