...
/***************************************************************************
  ...
  ------------
    ...
    classes/inst/ostream.cpp).  The function header is the following:
...
// #include <strstream.h>
#include	<strstream>
using std::istrstream; //by SH 05/20/2005
...
template <class Label>
std::istream& operator >> ( std::istream&, inst<Label>&); //by SH 05/25/2005
...
#ifdef _MSC_VER      
	    #if  _MSC_VER>=1300
		friend std::istream& operator >> <Label> ( std::istream&, inst<Label>&);
		#endif  
