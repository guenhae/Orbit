/******************************************************************************
 File: 	classes/afa/dnf/termsim.cpp
 -----
...
Description:
	...
	of B**n in order of increasing weight.  (See classes/afa/manage_bitvec.cpp for details).
	This results in much faster bit-vector handling.

Parameters:
	const term& t			-term to simplify with	
	unsigned *ord_inv		-see classes/afa/manage_bitvec.cpp for details	
